...
function State = UpdateInternalState( State)
    ...
    % USE the c code here!!!!
%     position = Point(State.fdbk.actual_posX, ...
%                      State.fdbk.actual_posY, ...
%                      State.fdbk.actual_posZ);
%                    
%     inZone = State.trialManager.inZone( position );
%     inTarget = State.trialManager.inTarget( position );
% 
%     State.calc.inZone = inZone;
%     State.calc.inTarget = inTarget;
