% SimpleMonkey
%
% An RTMA module that generates an "ideal" movement command
...
function SimpleMonkey(config_file, mm_ip)
    ...
    ConnectArgs = {'SILICON_MONKEY', '', RTMAConfigFile};
...
function SendPlannerMovementCommand( Vel, SampleHeader, Tag, controlled_dims)
    ...
    global RTMA;
    msg = RTMA.MDF.PLANNER_MOVEMENT_COMMAND;
