function [QL] = InsertSampleGeneratedMsg(QL)
    ...
    QL.Headers.SAMPLE_GENERATED.send_time(1) = QL.Headers.SAMPLE_GENERATED.send_time(1) - DT;
    QL.Headers.SAMPLE_GENERATED.recv_time(1) = QL.Headers.SAMPLE_GENERATED.recv_time(1) - DT;
    QL.Headers.SAMPLE_GENERATED.msg_count(1) = QL.Headers.SAMPLE_GENERATED.msg_count(1) - 2;

    %
    % Data
    %
    tstmp = QL.Data.SAMPLE_GENERATED.source_timestamp(1) - DT;
