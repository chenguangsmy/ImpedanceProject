...
function CompareStructs(S1, S2)
    ...
    DiffCnt = 0;
    DiffCnt = CompareField( S1, S2, DiffCnt, 1, s2_name);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [DiffCnt, Result] = CompareField( S1, S2, DiffCnt, level, s2_name)
        ...
        case 'struct'
            ...
            for i = 1 : length( SubFieldNames)
                ...
                if (isfield(S2,SubFieldName))
                    D1 = S1.(SubFieldName);
                    D2 = S2.(SubFieldName);
                    [DiffCnt, Result] = CompareField( D1, D2, DiffCnt, level+1, s2_name);
